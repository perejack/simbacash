        ...
        <div className="grid grid-cols-1 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              We supply dependable cement and paving solutions designed for real jobsite demands.
              Our range is produced with modern processes and verified against tight quality checks,
              so you get consistent strength, clean finishes, and easy application. Choose from
              practical options and finishes to match residential, commercial, or infrastructure
              needs—delivered on time and ready to work.
            </p>
                ...
                {[
                  ...
                  <div key={index} className="product-card-modern">
                    ...
                    <div className="buttons-container">
                      ...
                      <a href="tel:+254750936321" className="btn btn-secondary">Enquire</a>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {[
                  ...
                  <div key={index} className="product-card-modern">
                    ...
                    <p className="product-description">Reliable reinforcement steel engineered for strength and durability.</p>
                    <div className="price-section">
                      <span className="current-price">{product.price}</span>
