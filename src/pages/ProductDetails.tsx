        ...
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="bg-white border rounded-lg p-6 md:p-8 relative">
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="info-item offer-time">Built to Perform</li>
              <li className="info-item offer-time">Quick to Apply</li>
            </ul>

            <div className="flex flex-col sm:flex-row gap-4">
              <a href="https://wa.me/254750936321" target="_blank" rel="noopener noreferrer" className="w-full">
                <Button className="w-full bg-green-600 hover:bg-green-700 text-white py-3">
                  Order via WhatsApp
                </Button>
              </a>
              <a href="tel:+254750936321" className="w-full">
        ...
        <div className="container mx-auto px-6 mt-16">
          <div className="bg-white border rounded-lg p-8">
            ...
            <p className="leading-relaxed text-muted-foreground">
              Explore specifications, typical applications, handling guidance, and user feedback for {name}.
              Add technical data and installation tips here to help customers choose with confidence.
            </p>
          </div>
        </div>
      </section>
